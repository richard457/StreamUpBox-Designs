 ...
 * @link https://github.com/StrimUp/angular-hovercard
 * @author Brian Park <yaru22@gmail.com>
 * @license MIT License, http://www.opensource.org/licenses/MIT
 */
/* global angular */
'use strict';
angular.module('StrimUp.hovercard', ['StrimUp.hovercard.tmpls']).directive('hovercard', function () {
  return {
    restrict: 'E',
    transclude: true,
...
angular.module('StrimUp.hovercard.tmpls', []).run([
  '$templateCache',
